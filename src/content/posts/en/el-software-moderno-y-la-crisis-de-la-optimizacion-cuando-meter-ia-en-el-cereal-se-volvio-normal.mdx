...
toc: true
heroImage: '../../../assets/images/posts/heroes/software-moderno.png'
heroImageAlt: "En mis tiempos, la IA era cosa de la ciencia ficción..."
---
import { Image } from 'astro:assets';
import win11 from '../../../assets/images/posts/software-moderno/windows11.png'
import winxp from '../../../assets/images/posts/software-moderno/windowsxp.png'
...
<figure>
  <Image
    src={win11}
    alt="Edge en Windows 11"
    widths={[400, 800, 1200]}
  />
  <figcaption>Edge en Windows 11</figcaption>
</figure>
<figure>
  <Image
    src={winxp}
    alt="IE en Windows XP"
    widths={[400, 800, 1200]}
  />
  <figcaption>Internet Explorer en Windows XP</figcaption>
</figure>
</div>
